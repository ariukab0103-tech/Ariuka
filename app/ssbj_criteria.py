...
SSBJ_CRITERIA = [
    ...
    # =========================================================================
    {
        ...
        "la_scope": "supporting",
        "la_priority": "important",
        "requirement": "Disclose sustainability-related risks and opportunities that could reasonably be expected to affect the entity's prospects, including those arising across the entity's entire value chain (IFRS S1 para 28-35). MUST also disclose the entity's definitions of short-term, medium-term, and long-term time horizons and how these relate to planning horizons (IFRS S1 para 30-31).",
        "internal_controls": "",
        "guidance": "Assess risks across short, medium, and long-term horizons. FIRST: define your time horizons (e.g., short = 0-3 years, medium = 3-10 years, long = 10-30 years) and disclose these definitions. Then assess each risk/opportunity against these horizons. MUST cover the entire value chain — upstream suppliers, own operations, and downstream customers/end-of-life. Disclose value chain assessment boundary (which parts were included/excluded and why).",
        "assurance_focus": "Documented risk register, time horizon definitions, methodology, value chain boundary disclosure, evidence of value chain consideration, hotspot identification.",
        "minimum_action": "(1) DEFINE time horizons: state your short/medium/long-term definitions (e.g., short = 0-3 yrs, medium = 3-10 yrs, long = 10-30 yrs) and link to your planning horizons — IFRS S1 para 30-31 requires this. (2) Create a risk register across your ENTIRE value chain (upstream → own operations → downstream). (3) For each risk, note time horizon, potential impact, and where in the value chain it occurs. (4) Disclose your assessment boundary: which parts of the value chain you assessed and which you could not (and why). (5) Identify hotspots — value chain nodes where risk concentrates.",
        "assurance_risk_note": "The auditor will ask: 'How did you define short, medium, and long-term? Where is this documented?' Undefined time horizons undermine comparability and consistency of all strategy disclosures. Value chain assessment without boundary disclosure is unverifiable — the auditor cannot assess completeness.",
    ...
    },
    {
        ...
        "la_priority": "important",
        "requirement": "Describe the current and anticipated effects of sustainability-related risks and opportunities on the entity's business model and ENTIRE value chain — from raw material sourcing through production, distribution, use, and end-of-life (IFRS S1 para 32-33). Disclose the boundary of the value chain assessment.",
        "internal_controls": "",
        "guidance": "Map the ENTIRE value chain: upstream (suppliers, raw materials), own operations, and downstream (distribution, customers, end-of-life). Identify where sustainability risks concentrate (hotspots) and how they affect the business model. Disclose assessment boundary: which parts were included, which were excluded, and why. This is mandatory — not just a nice-to-have.",
        "assurance_focus": "Complete value chain mapping, boundary disclosure, hotspot identification, business model impact assessment, dependency analysis across upstream and downstream.",
        "minimum_action": "(1) Map your ENTIRE value chain from upstream to downstream. (2) For each stage (raw material sourcing → manufacturing → distribution → use → end-of-life), identify sustainability dependencies and vulnerabilities. (3) Identify hotspots — where do risks concentrate most? (4) Disclose your assessment boundary: which suppliers/customers/value chain nodes are included vs excluded, and why. (5) If Year 1 proportionality relief applies, document which parts you could not assess and your expansion plan.",
        "assurance_risk_note": "Value chain mapping without boundary disclosure is unverifiable. The auditor will ask: 'What Tier 1/2/3 suppliers were included? What about downstream end-of-life?' If the entity cannot describe its boundary, the auditor will flag a potential scope limitation.",
    ...
    },
    {
        ...
        "requirement": "Describe the current and anticipated effects on the entity's financial position, financial performance, and cash flows (IFRS S1 para 34-35). Quantitative information is preferred; qualitative disclosure acceptable under SSBJ two-stage disclosure (二段階開示) if quantification is not practicable, but explain why.",
        "internal_controls": "",
        "guidance": "Address three dimensions: (1) financial position (balance sheet impact), (2) financial performance (P&L impact), (3) cash flows. Where quantification is not yet possible, provide qualitative narrative and explain why quantitative amounts are not practicable. SSBJ two-stage disclosure allows qualitative in Year 1 with progressive quantification. Note: 'cost of capital' and 'access to finance' are scope criteria in IFRS S1 (para 3) — they define which risks to consider, not separate disclosure outputs.",
        "assurance_focus": "Coverage of all three financial effect dimensions (position, performance, cash flows), methodology for quantification attempts, documented explanation if only qualitative.",
        "minimum_action": "(1) Qualitative discussion of how sustainability risks affect: financial position, financial performance, and cash flows. (2) If you cannot quantify, explain why (good practice under SSBJ proportionality — the auditor will ask). (3) SSBJ two-stage disclosure allows qualitative in Year 1. (4) Reference specific financial statement line items where possible (see STR-07 for connectivity mapping).",
        "assurance_risk_note": "Purely qualitative disclosure without explaining why quantification is not possible may be challenged. The auditor will ask: 'Did you attempt to quantify? Why was it not practicable?' Companies should document their quantification efforts even if the result is qualitative disclosure. Under conservative practice, 'we didn't try' is not an acceptable answer.",
    ...
    },
    {
        ...
        "la_scope": "not_in_initial_scope",
        "la_priority": "important",
        "requirement": "Describe climate-related scenario analysis, including (a) scenarios used, (b) key assumptions and parameters for each, (c) how the entity used the analysis to inform its strategy, and (d) the resilience of the entity's strategy (IFRS S2 para 22). Resilience assessment is MANDATORY for climate under IFRS S2.",
        "internal_controls": "",
        "guidance": "Use at least two scenarios including one consistent with 1.5°C. For each scenario: (1) name the scenario and source, (2) disclose key assumptions (temperature pathway, policy assumptions, technology mix, time horizon), (3) describe how the analysis informed or confirmed strategy. Resilience assessment is mandatory under IFRS S2 — not recommended.",
        "assurance_focus": "Scenario selection rationale, documented assumptions per scenario, evidence of strategy feedback (how analysis influenced decisions), resilience conclusion.",
        "minimum_action": "(1) Select two off-the-shelf scenarios (e.g., IEA NZE 2050 for transition, IPCC RCP 8.5 for physical). (2) Disclose key assumptions for each (temperature target, policy assumptions, time frame). (3) Write qualitative narrative on how your strategy holds up under each scenario. (4) State how the analysis informed or confirmed your strategy. (5) Assess entity's resilience — this is MANDATORY under IFRS S2, not optional. SSBJ allows proportionality on methodology but not on disclosure.",
        "assurance_risk_note": "A narrative saying 'we considered IEA NZE' without disclosing assumptions gives the auditor nothing to test. The auditor will ask: 'What assumptions did you use? How did results change your strategy?' If the entity cannot answer, the scenario disclosure is decorative. Conservative firms flag the gap between scenario section and strategy section as inconsistency.",
    ...
    },
    {
        ...
        "la_scope": "not_in_initial_scope",
        "la_priority": "nice_to_have",
        "requirement": "Describe the resilience of the entity's strategy and business model to sustainability-related risks. Note: for climate specifically, resilience assessment IS mandatory under IFRS S2 para 22 (covered in STR-04). This criterion addresses broader sustainability resilience (SHOULD).",
        "internal_controls": "",
        "guidance": "Assess adaptability of business model under different scenarios. For climate resilience specifically, see STR-04 — it is mandatory. This criterion covers broader sustainability resilience which is recommended (SHOULD, not SHALL).",
        "assurance_focus": "Documented resilience assessment. Climate resilience is tested under STR-04.",
        "minimum_action": "For broader sustainability: not required for minimum compliance (SHOULD, not SHALL). However, CLIMATE resilience is mandatory under STR-04/IFRS S2. If you address broader sustainability resilience, provide a brief qualitative statement.",
        "assurance_risk_note": "Climate resilience is mandatory under IFRS S2 para 22 and tested through STR-04. Companies should not confuse this criterion's 'recommended' status with climate resilience being optional — it is not.",
